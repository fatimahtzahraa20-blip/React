...
export default function DashboardSidebar() {
  ...
  const navigation: NavigationItem[] = isAdmin
    ...
    : [
        { label: "My videos", to: "/dashboard/videos", icon: Video },
        { label: "Add video", to: "/dashboard/add-video", icon: PlusCircle },
  ...
  return (
    <aside className="dashboard-sidebar flex min-h-screen w-72 flex-col p-5 text-white">
      ...
      <div className="mb-6 rounded-2xl border border-white/10 bg-white/5 px-4 py-3">
        <p className="text-xs font-semibold uppercase tracking-[0.16em] text-purple-300">{isAdmin ? "Administrator" : "Creator workspace"}</p>
